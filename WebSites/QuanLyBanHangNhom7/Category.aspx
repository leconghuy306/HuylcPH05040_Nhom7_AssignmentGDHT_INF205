                    ...
                    <div class="col-md-10">
                        <div class="group-tabs">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a id="A4" runat="server" href="~/Category">Category</a></li>
                        ...
                        <div class="tab-content">
                            <h3 style="text-align:center; font-weight:bold;">Category Managerment</h3>
                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="productcategory_id" DataSourceID="ProductList" InsertItemPosition="LastItem">
                                ...
                                <EditItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:Label ID="productcategory_idLabel1" runat="server" Text='<%# Eval("productcategory_id") %>' />
                                        </td>
                                        <td>
                                ...
                                <InsertItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:TextBox ID="productcategory_idTextBox" runat="server" Text='<%# Bind("productcategory_id") %>' />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="parent_category_idTextBox" runat="server" Text='<%# Bind("parent_category_id") %>' />
                                        </td>
                            ...
                            <asp:SqlDataSource ID="ProductList" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [productcategory] WHERE [productcategory_id] = @productcategory_id" InsertCommand="INSERT INTO [productcategory] ([productcategory_id], [parent_category_id], [names]) VALUES (@productcategory_id, @parent_category_id, @names)" SelectCommand="SELECT [productcategory_id], [parent_category_id], [names] FROM [productcategory]" UpdateCommand="UPDATE [productcategory] SET [parent_category_id] = @parent_category_id, [names] = @names WHERE [productcategory_id] = @productcategory_id">
                                <DeleteParameters>
