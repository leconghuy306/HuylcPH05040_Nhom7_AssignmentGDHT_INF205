<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Purchase.aspx.vb" Inherits="Purchase" %>
...
=======
                            <a href="">My account</a>
                            <a href="">thang2</a>
>>>>>>> 03b30fd81939ab68d986047316b72bf4d6a5cf23
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-10">
                        <div class="group-tabs">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a id="A5" runat="server" href="~/Purchase">Purchase</a></li>
                        ...
                        <div class="tab-content">
                            <h3 style="text-align:center; font-weight:bold;">Purchase Managerment</h3>
                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="purchase_id" DataSourceID="ProductList" InsertItemPosition="LastItem">
...
=======
                                            <asp:Label ID="purchase_idLabel" runat="server" Text='<%# Eval("purchase_id") %>'  />
>>>>>>> bed2101c1471a9e930200e417864554eb7df9fa5
                                        </td>
                                        <td>
                                ...
                                <ItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:Label ID="purchase_idLabel" runat="server" Text='<%# Eval("purchase_id") %>' CssClass="thusua"/>
                                        </td>
                                        <td>
                                            <asp:Label ID="purchase_noLabel" runat="server" Text='<%# Eval("purchase_no") %>' />
                                        </td>
                            ...
                            <asp:SqlDataSource ID="ProductList" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [purchase] WHERE [purchase_id] = @purchase_id" InsertCommand="INSERT INTO [purchase] ([purchase_id], [purchase_no], [client_id]) VALUES (@purchase_id, @purchase_no, @client_id)" SelectCommand="SELECT [purchase_id], [purchase_no], [client_id] FROM [purchase]" UpdateCommand="UPDATE [purchase] SET [purchase_no] = @purchase_no, [client_id] = @client_id WHERE [purchase_id] = @purchase_id">
                                <DeleteParameters>
