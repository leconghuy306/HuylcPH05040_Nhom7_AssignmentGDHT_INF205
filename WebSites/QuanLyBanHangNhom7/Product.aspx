                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="tab-content">
                                ...
                                <AlternatingItemTemplate>
                                    <tr style="">
                                        <td style="">
                                            ...
                                            <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="Edit" CssClass="btn btn-danger" />
                            ...
                            <asp:SqlDataSource ID="ProductList" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [product] WHERE [product_id] = @product_id" InsertCommand="INSERT INTO [product] ([product_id], [productcategory_id], [names], [img], [price], [sku], [discription]) VALUES (@product_id, @productcategory_id, @names, @img, @price, @sku, @discription)" SelectCommand="SELECT [product_id], [productcategory_id], [names], [img], [price], [sku], [discription] FROM [product]" UpdateCommand="UPDATE [product] SET [productcategory_id] = @productcategory_id, [names] = @names, [img] = @img, [price] = @price, [sku] = @sku, [discription] = @discription WHERE [product_id] = @product_id" ProviderName="System.Data.SqlClient">
                                <DeleteParameters>
